...
struct cg_globState
{
	static double screenSize[2];	// Fenstergr��e in Pixel
	static GLenum drawMode;			// Zeichenmodus f�r Fl�chen {GL_LINE || GL_FILL}
	...
	static int cameraHelper[2];		// Mausposition, benoetigt f�r Kamera-Positionierung
